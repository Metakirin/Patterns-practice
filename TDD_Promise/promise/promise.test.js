const MetakirinPromise = require('./promise')
...
describe('Vladilen Promise: ', () => {
  ...
  beforeEach(() => {
    ...
    promise = new MetakirinPromise(executorSpy)
  })

  test('should exists and to be typeof function', () => {
    expect(MetakirinPromise).toBeDefined()
    expect(typeof MetakirinPromise).toBe('function')
  })
  ...
  test('should catch error', () => {
    ...
    const errorPromise = new MetakirinPromise(errorExecutor)
